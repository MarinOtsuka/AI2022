...
st.sidebar.title("洋服識別アプリ")
st.sidebar.write("あなたの身につけているものが何かを判定します")

st.sidebar.write("")

img_source = st.sidebar.radio("画像のソースを選択してください。",
                              ("過去の服(画像をアップロード)", "今の服(カメラで撮影)"))
if img_source == "過去の服(画像をアップロード)":
    img_file = st.sidebar.file_uploader("画像を選択してください。", type=["png", "jpg"])
elif img_source == "今の服(カメラで撮影)":
    img_file = st.camera_input("今の服(カメラで撮影)")
